...
files += ['faculty_exports/audits/'+f for f in ['microeconomics_audit.md','microeconomics_audit_findings.json','microeconomics_audit_coverage.json','microeconomics_audit_evidence.json','microeconomics_consolidated_cleanup.md','microeconomics_consolidated_cleanup_changes.json','microeconomics_final_verification.md','microeconomics_final_verification.json']]
def digest(name):
    try:
