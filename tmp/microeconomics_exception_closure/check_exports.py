...
(root/'tmp/microeconomics_exception_closure/companion_exports.json').write_text(json.dumps(companion),encoding='utf-8')
...
(root/'tmp/microeconomics_exception_closure/export_checks.json').write_text(json.dumps(result,indent=2),encoding='utf-8')
