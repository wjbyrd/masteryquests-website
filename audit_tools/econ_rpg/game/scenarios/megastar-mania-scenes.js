...
export default {
  ...
  variants: [
    ...
    variant('expanded-tour', 'More dates and seats on the tour map', 'A large illuminated tour map dominates the waterfront scene, with many connected stops, touring buses and production equipment. This view marks the decision to add tour dates. The map represents more performances and seats, not a claim about ticket sales or consumer demand.', all(chosen('expansion.dates'), not(illness)), ['consequence']),
