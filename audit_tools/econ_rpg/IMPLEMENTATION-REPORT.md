...
The later pass using the supplied image reference is documented in [ART-QA-REPORT.md](ART-QA-REPORT.md), with the current five-view mobile/desktop screenshot set and the v1 art bible.
