...
// Assessment-aligned display labels; stable groups, selectors and merges are unchanged.
Object.assign(module.exports.labels, {
  "ad-as-equilibrium-and-output-gaps-equilibrium-gaps": "Interpret AD-AS equilibrium and distinguish recessionary and inflationary output gaps",
  "aggregate-demand-slope": "Interpret the aggregate-demand curve and trace the causes of its slope",
  "aggregate-demand-shifts": "Identify aggregate-demand shifters and predict their effects",
  "central-bank-and-federal-reserve-institutions": "Identify central-bank roles and structure; analyze independence and policy decisions",
  "competitive-short-run-supply-coverage": "Determine short-run firm and market supply and distinguish fixed- from variable-cost shifts",
  "competitive-shutdown-coverage": "Apply the AVC shutdown rule and distinguish producing at a loss, shutdown, and exit",
  "consumer-choice-budget": "Interpret budget constraints and calculate affordable bundles",
  "consumer-choice-preferences": "Interpret preferences, indifference curves, and ordinal utility",
  "consumer-surplus-valuation": "Use willingness to pay to calculate and interpret consumer surplus",
  "cost-components-schedules-coverage": "Calculate and interpret fixed, variable, and total costs in short-run schedules",
  "demand-core-behavior": "Apply the law of demand and distinguish movements from shifts",
  "demand-and-supply-shocks-supply-shocks": "Trace supply shocks and identify stagflation",
  "elasticity-demand": "Calculate demand elasticity and analyze its determinants",
  "externalities-external-effects": "Identify external effects and determine socially efficient outcomes",
  "factor-markets-productivity-hiring": "Calculate marginal product and its value to determine hiring",
  "fiscal-multipliers-and-crowding-out-multiplier": "Calculate and apply the spending multiplier",
  "fiscal-policy-and-aggregate-demand-government-spending": "Identify fiscal policy actions and predict government-purchase effects on demand",
  "gains-from-trade-comparative-advantage": "Apply opportunity costs and specialization to determine gains from trade",
  "gdp-components-expenditure": "Classify GDP expenditure components and calculate their contributions",
  "information-asymmetry-behavioral-and-political-economy-behavior": "Identify behavioral biases and apply them to economic decisions",
  "integrated-economic-analysis-coverage": "Apply economic models to linked market and macroeconomic scenarios",
  "liquidity-preference-and-money-market-equilibrium": "Apply liquidity preference to determine money-market equilibrium",
  "market-equilibrium-equilibrium": "Determine equilibrium and predict shortage and surplus adjustment",
  "mcomp-advertising-nonprice-coverage": "Analyze advertising, product differentiation, and nonprice competition",
  "mcomp-efficiency-variety-limits-coverage": "Evaluate product variety and the efficiency limits of monopolistic competition",
  "mcomp-entry-exit-long-run-coverage": "Trace entry and exit to long-run profit, markups, and excess capacity",
  "models-and-assumptions-models": "Interpret economic models, assumptions, and simplification",
  "money-functions-and-measures-functions-forms": "Identify money functions and distinguish forms and payment technologies",
  "monopolistic-competition-long-run-welfare": "Analyze entry, exit, excess capacity, and welfare tradeoffs",
  "monopoly-power": "Identify monopoly power and distinguish barriers to entry",
  "oligopoly-structure": "Identify oligopoly and analyze strategic interdependence",
  "oligopoly-collusion": "Analyze cartels, collusion, and incentives to cheat",
  "oligopoly-collusion-cartels-coverage": "Analyze cartel pricing, welfare, and incentives to cooperate or cheat",
  "oligopoly-dynamic-strategy-coverage": "Analyze repeated interaction, credible commitments, and entry deterrence",
  "oligopoly-rivalry-coordination-coverage": "Analyze rivalry and tacit coordination; distinguish parallel behavior from collusion",
  "oligopoly-structure-concentration-concentration": "Identify oligopoly and entry barriers; calculate and interpret market concentration",
  "oligopoly-welfare-policy-coverage": "Evaluate concentration, mergers, cartel welfare, and antitrust tradeoffs",
  "perfect-competition-firm-choice": "Identify price taking and apply revenue and marginal output rules",
  "price-elasticity-of-demand-determinants": "Compare determinants of demand responsiveness",
  "price-elasticity-of-supply-determinants": "Compare supply responsiveness across capacity limits and adjustment periods",
  "price-signals-coverage": "Trace price signals through buyer, seller, and resource-allocation decisions",
  "producer-surplus-valuation": "Use willingness to accept to calculate and interpret producer surplus",
  "public-goods-and-common-resources-classification": "Classify goods by rivalry and excludability and identify free-rider incentives",
  "scarcity-and-tradeoffs-scarcity-choice": "Identify scarcity, tradeoffs, and opportunity cost",
  "supply-core-behavior": "Apply the law of supply and distinguish movements from shifts",
  "tax-incidence-elasticity-incidence": "Use relative elasticity to determine who bears a tax",
  "total-surplus-gains-from-exchange-coverage": "Calculate and interpret total surplus and gains from exchange"
});
