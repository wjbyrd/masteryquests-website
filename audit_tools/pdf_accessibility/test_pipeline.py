...
def main():
    parser=argparse.ArgumentParser();parser.add_argument('--run',choices=['pilot_blockers_v1','full_batch_v1'],default='pilot_blockers_v1')
    ...
    records=read_json(out/('fixture_validation.json' if run=='full_batch_v1' else 'validation.json'));receipt=out/'review_receipt.json'
