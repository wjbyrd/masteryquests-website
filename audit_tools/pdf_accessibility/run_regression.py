...
if phase not in ('baseline','final','pilot_blockers_v1','full_batch_v1_baseline','full_batch_v1_general','full_batch_v1_micro','full_batch_v1_macro','full_batch_v1_final','blocked_25_v1','micro49_nash_fix_v1','micro49_unique_nash_v2','owner_qa_remediation_v1','style_restoration_v1','canonical_completion_v1','public_sync_v1','final_qa_20260919'):
...
if phase in ('micro49_nash_fix_v1','micro49_unique_nash_v2','owner_qa_remediation_v1','style_restoration_v1','canonical_completion_v1','public_sync_v1','final_qa_20260919'):scratch=contained(f'tmp/pdf_accessibility/{phase}/regression')
...
if phase in ('micro49_nash_fix_v1','micro49_unique_nash_v2','owner_qa_remediation_v1','style_restoration_v1','canonical_completion_v1','public_sync_v1','final_qa_20260919'):out=contained(f'validation_artifacts/pdf_accessibility/{phase}/regression')
...
write_json(out/'results.json',{'task':'CONCEPT_REVIEW_FINAL_QA_20260919' if phase=='final_qa_20260919' else 'PDF_ACCESSIBILITY_BLOCKED_25_V1' if phase=='blocked_25_v1' else 'PDF_ACCESSIBILITY_FULL_BATCH_V1' if phase.startswith('full_batch_v1') else TASK,'phase':phase,'total':len(results),'passed':sum(r['passed'] for r in results),'results':results,'temporaryDirectory':str(scratch)})
