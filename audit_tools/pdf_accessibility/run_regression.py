...
if phase not in ('baseline','final','pilot_blockers_v1','full_batch_v1_baseline','full_batch_v1_general','full_batch_v1_micro','full_batch_v1_macro','full_batch_v1_final','blocked_25_v1','micro49_nash_fix_v1','micro49_unique_nash_v2','owner_qa_remediation_v1','style_restoration_v1','canonical_completion_v1','public_sync_v1'):
...
if phase in ('micro49_nash_fix_v1','micro49_unique_nash_v2','owner_qa_remediation_v1','style_restoration_v1','canonical_completion_v1','public_sync_v1'):scratch=contained(f'tmp/pdf_accessibility/{phase}/regression')
...
if phase in ('micro49_nash_fix_v1','micro49_unique_nash_v2','owner_qa_remediation_v1','style_restoration_v1','canonical_completion_v1','public_sync_v1'):out=contained(f'validation_artifacts/pdf_accessibility/{phase}/regression')
