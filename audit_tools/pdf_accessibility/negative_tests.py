...
parser=argparse.ArgumentParser();parser.add_argument("--run",choices=["pilot_blockers_v1","full_batch_v1"],default="pilot_blockers_v1");parser.add_argument("--validation")
