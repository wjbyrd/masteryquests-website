...
parser=argparse.ArgumentParser();parser.add_argument("--run",choices=["pilot_blockers_v1","full_batch_v1","blocked_25_v1","micro49_nash_fix_v1","micro49_unique_nash_v2","owner_qa_remediation_v1"],default="pilot_blockers_v1");parser.add_argument("--validation")
...
if RUN in ('full_batch_v1','blocked_25_v1','micro49_nash_fix_v1','micro49_unique_nash_v2','owner_qa_remediation_v1'):
