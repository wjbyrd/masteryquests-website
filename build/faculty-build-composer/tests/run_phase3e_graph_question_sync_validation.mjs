...
async function run() {
  ...
  pass(library.canonicalQuestionCount === 9379, `Canonical count ${library.canonicalQuestionCount}`);
  pass(manifest.canonicalQuestionCount === 9379, `Manifest canonical count ${manifest.canonicalQuestionCount}`);
