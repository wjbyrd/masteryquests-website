...
QF=ROOT/'phaseMicro8-oligopoly-granularity-adaptive-backfill-v1_questions.json'
...
for q in new:
    ...
    if q.get('familyConceptId')!='oligopoly' or len(q.get('subtopicIds',[]))!=1: issues.append(f'{qid} family/subtopic metadata')
