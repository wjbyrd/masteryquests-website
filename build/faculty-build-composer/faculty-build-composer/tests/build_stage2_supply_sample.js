...
(async()=>{
 const recipe={schemaVersion:'1.2.0',title:'Supply Mastery Quest',slug:'supply-mastery-quest',supportedModes:['standard','timed','exam','legendary','score'],selectedConceptIds:['supply'],checkpointFocus:{checkpointOne:null,checkpointTwo:null,finalCheckpoint:null}};
 ...
 fs.writeFileSync(path.join(root,'tests','stage2-supply-sample.html'),html);
 fs.writeFileSync(path.join(root,'tests','stage2-supply-sample-manifest.json'),JSON.stringify({...metadata,poolCounts:composition.counts},null,2));
