...
const require=createRequire(import.meta.url),repo='C:/Users/Jennings/Documents/GitHub/masteryquests-website',work=path.resolve('.saving-work');
...
const recipe={schemaVersion:core.RECIPE_SCHEMA_VERSION,title:'Saving, Investment, Budgets & Debt audit validation',slug:'macro-saving-investment-budgets-debt-audit',guideName:'Guide',selectedConceptIds:selected,supportedModes:core.MODE_ORDER,checkpointFocus:Object.fromEntries(core.CHECKPOINT_ORDER.map(k=>[k,null]))};
