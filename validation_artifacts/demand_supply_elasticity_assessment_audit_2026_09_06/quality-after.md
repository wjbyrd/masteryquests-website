...
Generated: 2026-09-07T01:25:36.161Z
...
- Library SHA-256: b071adea394fbb8d33322bf5c0ca9fc3af3faf6af2dacd03508fa2976e683b9c
...
| Severity | Rule | Count |
|---|---|---:|
| REVIEW | answer-length-outlier | 19 |
| REVIEW | near-duplicate-stem | 1 |
| REVIEW | possible-difficulty-overstatement | 45 |
| REVIEW | weak-absolute-distractors | 56 |
...
| P52B-PSIG-L-001 | price-signals | legendary | 2 | possible-difficulty-overstatement, weak-absolute-distractors |
...
| PG1-SUP-L-003 | supply | legendary | 2 | graph-question-evidence-mismatch, possible-difficulty-overstatement |
...
### WARNING — PG1-SUP-L-003 — graph-question-evidence-mismatch

- Concept: supply
- Pools: legendary
- Current wording: Refer to the graph. A process improvement changes supply from S0 to S1. Starting at A, find the price on S1 that restores the initial quantity. What does the unchanged final quantity mean?
...
- Concept: elasticity
- Pools: legendary
- Current wording: Holding other factors fixed, an 8% increase in camera prices reduces demand for a compatible lens by 6%. A supplier next forecasts a 4% camera-price decrease. Which cross-price estimate and approximate lens-demand forecast are consistent?
...
### REVIEW — P62B-ELAS-L-092 — possible-difficulty-overstatement

- Concept: elasticity
- Pools: legendary
- Current wording: Refer to the graph. A seller at A can choose the posted price at A, B, or C and can serve all buyers. It wants higher revenue while retaining at least 50 unit sales. Which price is best, and what explains the result?
- Reason: legendary metadata may overstate a direct recognition or graph-reading task.
- Suggested direction: Confirm that the item requires work appropriate to its assigned difficulty.
...
- Pools: elite
- Current wording: Refer to the graph. The market price starts at $2 and can adjust freely. Which pair of quantity changes would eliminate the initial imbalance with both curves fixed?
- Reason: elite metadata may overstate a direct recognition or graph-reading task.
- Suggested direction: Confirm that the item requires work appropriate to its assigned difficulty.
...
### REVIEW — P52B-PSIG-L-001 — possible-difficulty-overstatement

- Concept: price-signals
- Pools: legendary
- Current wording: An electricity supplier charges more during evening peaks and less overnight. Some households can delay appliance use, while others need electricity immediately. Which response shows how the price signal can coordinate scarce capacity?
- Reason: legendary metadata may overstate a direct recognition or graph-reading task.
- Suggested direction: Confirm that the item requires work appropriate to its assigned difficulty.

### REVIEW — P52B-PSIG-L-001 — weak-absolute-distractors
...
- Concept: supply
- Pools: legendaryBoss
- Current wording: Evaluate the competing effects of a cost-saving production technology and a new compliance cost. What can be inferred about the net supply shift without relative magnitudes?
- Reason: 3 distractors rely on absolute wording while the correct answer does not.
...
### REVIEW — PG1-SUP-L-002 — possible-difficulty-overstatement

- Concept: supply
- Pools: legendary
- Current wording: Refer to the graph. Producers initially supply on S0 at $9. Input costs then change so the relevant curve is S1. What price would restore the original quantity, and what accounts for the restoration?
- Reason: legendary metadata may overstate a direct recognition or graph-reading task.
- Suggested direction: Confirm that the item requires work appropriate to its assigned difficulty.

### REVIEW — PG1-SUP-L-003 — possible-difficulty-overstatement
