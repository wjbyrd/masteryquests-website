...
Generated: 2026-09-08T17:25:16.080Z
...
- Library SHA-256: 72d8c80a2030480938603227f28c90f73788e7b7f3b624d0861aa5e54f0ec370
...
- REVIEW: 62
- Total findings: 114
- Unique questions affected: 106
- Questions with multiple findings: 8
...
| Severity | Rule | Count |
|---|---|---:|
| REVIEW | answer-length-outlier | 16 |
| REVIEW | possible-difficulty-overstatement | 21 |
| REVIEW | possible-difficulty-understatement | 1 |
| REVIEW | weak-absolute-distractors | 24 |
| WARNING | graph-prompt-missing-cue | 46 |
| WARNING | repeated-feedback | 6 |
...
|---|---:|
| externalities | 79 |
| public-goods-and-common-resources | 30 |
| market-power | 5 |
...
- Concept: externalities
- Pools: elite
- Current wording: Refer to the gardens graph. A producer subsidy supports the social-intersection quantity. Which fiscal and price account is consistent with both the graph and payment on every garden produced?
- Reason: elite metadata may overstate a direct recognition or graph-reading task.
- Suggested direction: Confirm that the item requires work appropriate to its assigned difficulty.
...
- Concept: externalities
- Pools: elite
- Current wording: A workshop can install a filter for $400 that avoids $900 of harm to its sole neighbor. Rights are enforceable, information is complete, bargaining is costless, and there are no wealth effects. Which prediction survives reversing the initial right to emit?
- Reason: 2 distractors rely on absolute wording while the correct answer does not.

### REVIEW — P77-MFAIL-L-022 — weak-absolute-distractors

- Concept: externalities
- Pools: legendary
- Current wording: A health agency observes that a vaccine subsidy increases vaccinations but an unrelated change also reduces exposure to infection. Which additional evidence is needed to judge whether the subsidy improves efficiency?
- Reason: 3 distractors rely on absolute wording while the correct answer does not.

### REVIEW — P52B-MFAIL-L-003 — weak-absolute-distractors

- Concept: market-power
- Pools: legendary
- Current wording: A broadband network has high fixed cost and low marginal cost. Marginal-cost pricing would expand valuable access but leave a financing deficit. Average-cost pricing can cover costs but excludes some users whose value exceeds marginal cost. Public support has a real collection cost. What information is needed to choose between the two rules?
- Reason: 3 distractors rely on absolute wording while the correct answer does not.

### REVIEW — P77-MFAIL-L-020 — weak-absolute-distractors

- Concept: market-power
- Pools: legendary
- Current wording: An exclusive right lets an innovator charge above marginal cost. Removing it would expand current access but could reduce future investment in similar products. Which evidence is needed before claiming removal raises welfare?
- Reason: 3 distractors rely on absolute wording while the correct answer does not.
...
### REVIEW — 42189 — weak-absolute-distractors

- Concept: public-goods-and-common-resources
- Pools: legendaryBoss
- Current wording: Refer to the coastal-protection graph and treat quantity as continuous. A council budgets $700 million to expand from 10 to 30 miles. With no fixed or financing costs, which assessment uses the changing marginal cost correctly?
- Reason: 3 distractors rely on absolute wording while the correct answer does not.
...
### REVIEW — 42199 — possible-difficulty-overstatement

- Concept: public-goods-and-common-resources
- Pools: legendaryBoss
- Current wording: Refer to the fireworks graph and treat displays as continuous. Suppose a proposal uses only North's willingness to pay to decide provision. What quantity and welfare loss result compared with using both neighborhoods' benefits, ignoring funding costs?
- Reason: legendary metadata may overstate a direct recognition or graph-reading task.
- Suggested direction: Confirm that the item requires work appropriate to its assigned difficulty.

### REVIEW — 42210 — weak-absolute-distractors

- Concept: public-goods-and-common-resources
- Pools: legendary
- Current wording: A town hires contractors to supply rival packed meals, an uncrowded archive behind a login, and an unencrypted nonrival warning broadcast. It proposes charging for each meal, opening the archive after securing full sponsorship, and coordinating payment for the warning through a binding community agreement. Which assessment links the goods characteristics to those funding choices?
- Reason: 2 distractors rely on absolute wording while the correct answer does not.
...
### REVIEW — 42285 — weak-absolute-distractors

- Concept: public-goods-and-common-resources
- Pools: legendary
- Current wording: A village's open fishery is depleted while its nonexcludable flood-warning system receives too few contributions. Leaders propose a catch fee and a collective warning-service fund. Which diagnosis explains why the two remedies target different margins?
- Reason: 2 distractors rely on absolute wording while the correct answer does not.
