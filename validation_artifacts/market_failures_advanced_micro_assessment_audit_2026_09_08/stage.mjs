...
const require=createRequire(import.meta.url),repo='C:/Users/Jennings/Documents/GitHub/masteryquests-website',work=path.resolve('.failures-work');
...
const recipe={schemaVersion:core.RECIPE_SCHEMA_VERSION,title:'Market Failures & Public Goods audit validation',slug:'market-failures-audit-validation',guideName:'Guide',selectedConceptIds:selected,supportedModes:core.MODE_ORDER,checkpointFocus:Object.fromEntries(core.CHECKPOINT_ORDER.map(k=>[k,null]))};
