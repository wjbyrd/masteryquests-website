...
const require=createRequire(import.meta.url),repo='C:/Users/Jennings/Documents/GitHub/masteryquests-website',work=path.resolve('.macro-measure-work');
...
const recipe={schemaVersion:core.RECIPE_SCHEMA_VERSION,title:'Macro Measurement audit validation',slug:'macro-measurement-audit-validation',guideName:'Guide',selectedConceptIds:selected,supportedModes:core.MODE_ORDER.filter(m=>m!=='trialGraph'),checkpointFocus:Object.fromEntries(core.CHECKPOINT_ORDER.map(k=>[k,null]))};
