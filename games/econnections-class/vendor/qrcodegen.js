...
((qrcodegen2) => {
  const _QrCode = class _QrCode {
    ...
    constructor(version, errorCorrectionLevel, dataCodewords, msk) {
      ...
      __publicField(this, "errorCorrectionLevel", errorCorrectionLevel);
      /*-- Fields --*/
  ...
  const _QrSegment = class _QrSegment {
    ...
    constructor(mode, numChars, bitData) {
      ...
      __publicField(this, "numChars", numChars);
      __publicField(this, "bitData", bitData);
      if (numChars < 0)
        throw new RangeError("Invalid argument");
  ...
  ((QrCode2) => {
    const _Ecc = class _Ecc {
      ...
      constructor(ordinal, formatBits) {
        __publicField(this, "ordinal", ordinal);
        __publicField(this, "formatBits", formatBits);
      }
    };
    /*-- Constants --*/
  ...
  ((QrSegment2) => {
    const _Mode = class _Mode {
      ...
      constructor(modeBits, numBitsCharCount) {
        __publicField(this, "modeBits", modeBits);
        __publicField(this, "numBitsCharCount", numBitsCharCount);
      }
      /*-- Method --*/
